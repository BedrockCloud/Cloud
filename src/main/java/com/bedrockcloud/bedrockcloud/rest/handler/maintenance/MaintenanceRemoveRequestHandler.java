...
public class MaintenanceRemoveRequestHandler implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if (Utils.isMaintenance(player)) {
            ...
            Utils.removeMaintenance(player);
            JSONObject responseObj = new JSONObject();
            responseObj.put("success", "Player " + player + " was removed from the maintenance list");
