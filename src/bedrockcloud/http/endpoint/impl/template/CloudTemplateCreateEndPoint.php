...
class CloudTemplateCreateEndPoint extends EndPoint {
    ...
    public function handleRequest(Request $request, Response $response): array {
        ...
        $startNewPercentage = ($request->data()->queries()->has("startNewPercentage") ? floatval($request->data()->queries()->get("startNewPercentage")) : 100.0);
        ...
        TemplateManager::getInstance()->createTemplate(Template::create($name, TemplateSettings::create($lobby, $maintenance, $static, $maxPlayerCount, $minServerCount, $maxServerCount, $startNewPercentage, $autoStart), $type));
